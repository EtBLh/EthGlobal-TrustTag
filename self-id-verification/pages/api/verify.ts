        ...
        try {
            ...
            if (userId) {
                ...
                const enabledDisclosures = {
                    ...
                    name: false,
                    nationality: false,
                    date_of_birth: true,  // 這行很重要，否則 Self App 預設會 proof_generation_failed
                    passport_number: false,
                    gender: false,
                    expiry_date: false
                };
            ...
            const configuredVerifier = new SelfBackendVerifier(
                "self-playground",
                "https://df78-42-72-239-22.ngrok-free.app",
            ...
            if (result.isValid) {
                ...
                res.setHeader(
                    'Set-Cookie',
                    `verifiedUserId=${userId}; Path=/; HttpOnly; SameSite=Strict; Secure`
                );
